...
class Response
{
    ...
    public function defaultJS()
    {
        ...
        $this->javascript[101] = '<script src="/assets/js/html5-qrcode.min.js"></script>';
        $this->javascript[102] = '<script src="https://unpkg.com/konva@9/konva.min.js"></script>';
    }
    ...
    public function page($content, $params, $styles = '')
    {
        ...
        $this->css[30] = '<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.13.11/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/fc-4.1.0/fh-3.2.4/r-2.3.0/sl-1.4.0/datatables.min.css"/>';
    ...
    public function error($content, $params = [])
    {
        $this->defaultCSS();
        $this->defaultJS();
        $this->css[100] = '<link rel="stylesheet" type="text/css" href="/assets/css/err.css">';
